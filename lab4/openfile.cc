...
//----------------------------------------------------------------------
// OpenFile::WriteBack
// 	Write back file head.
//----------------------------------------------------------------------

void OpenFile::WriteBack(void)
{
...
time_t OpenFile::GetModTime()  // Get last modify time
{
    return hdr->getModTime();
}

void OpenFile::SetModTime(time_t modTime)  // Set last modify time
{
